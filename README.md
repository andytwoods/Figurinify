...
`gmain.py` is a standalone utility for downloading 3D models.
...
pip install tk requests pyinstaller

pyinstaller --noconfirm --clean --onefile --console --name "glb-downloader" main.py
...
pyinstaller --noconfirm --clean --onefile --windowed --name "GLB Downloader" main.py
